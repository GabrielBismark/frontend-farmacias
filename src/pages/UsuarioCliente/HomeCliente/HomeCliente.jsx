...
export const HomeCliente = () => {
  ...
  useEffect(() => {
    const fetchProdutos = async () => {
      try {
        const response = await axios.get("https://backend-farmacias.onrender.com/fornecedor/produto/"); // Atualize com a URL da sua API
  ...
  const handleSearch = async () => {
    try {
      const response = await axios.get(`https://backend-farmacias.onrender.com/produtos?search=${searchQuery}`);
      setProdutos(response.data);
    } catch (error) {
